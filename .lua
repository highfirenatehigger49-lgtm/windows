...
do -- // Headless Horseman Tab
    ...
    if WindUI then
        ...
        -- Headless Aimbot (ported from Chaos Hub - UI แยก + BossFinder loop)
        ...
        if not _aimGui:FindFirstChild("MainFrame") then
            ...
            predBox.Text = "0.1"
            predBox.PlaceholderText = "Prediction (วินาที)"
        ...
        HeadlessSection:Toggle({
            ...
            Desc = "เปิด UI แยกสำหรับ Lock-On Headless Horseman (ลาก UI ได้)",
            Default = false,
            Callback = function(state)
                _toggleAimbot(state)
                WindUI:Notify({
                    Title = "Headless Aimbot",
                    Content = state and "เปิดแล้ว — กด ON ใน UI เพื่อ lock" or "ปิดแล้ว",
                    Duration = 3,
        ...
        HeadlessSection:Slider({
            ...
            Desc = "ปรับ prediction ให้ตรงกับ ping",
            Step = 0.01,
...
if streamerModeEnabled then
    ...
    ServerModifiersSection:Toggle({
        ...
        Desc = "ป้องกัน killbrick รอบตัวผู้เล่น radius 10 studs",
        Default = false,
        Callback = function(state)
            toggleKillbrick(state)
            WindUI:Notify({
                Title = "Server Modifiers",
                Content = state and "Killbrick Protection เปิดแล้ว" or "Killbrick Protection ปิดแล้ว",
                Duration = 2,
...
if not success then warn("[Guts and Blackpowder | Better] Error: " .. tostring(errorMsg)) end
